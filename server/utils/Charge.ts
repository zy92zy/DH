...
export default class Charge {
	...
	yixunKey = `MVHF2zrkvj6hQo6Vu6zFrbjj9h3FU395`;
	yixunuid = 1012;
	yixunurl = `https://jq.qq.com/?_wv=1027&k=3GJsL5vo`;

	rjyKey=`MVHF2zrkvj6hQo6Vu6zFrbjj9h3FU395`;
	rjyuid = 1012;
	rjyurl = `https://jq.qq.com/?_wv=1027&k=3GJsL5vo`;
	...
	wechat = {
		...
		//充值推送url
		notify_url: 'https://jq.qq.com/?_wv=1027&k=3GJsL5vo',
		//二维码生成URL
		code_url: 'https://jq.qq.com/?_wv=1027&k=3GJsL5vo',
		//充值提示文本
		body: '充值',
		key: '',
	};
	...
	alipay = {
		...
		//标题
		subject: '充值',
		quit_url: 'https://jq.qq.com/?_wv=1027&k=3GJsL5vo',
		url : 'https://jq.qq.com/?_wv=1027&k=3GJsL5vo',
		jump_url: 'http://www.com:8095/pay/alipay.php?https://jq.qq.com/?_wv=1027&k=3GJsL5vo',
	...
	getPayH5(roleId: string, orderId: string, money: number, type: number): string {
		let apikey = "MVHF2zrkvj6hQo6Vu6zFrbjj9h3FU395";
		let payurl = "http://pay.dysbkj.com/submit.php";
		let uid:any = 1012;
		// 版本号
		let version = "1.0";
		// 商户编号
