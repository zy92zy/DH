...
export default class FeiLongZaiTian_Huo extends SkillBase {
	constructor() {
		super();
		this.skill_id = ESkillType.FeiLongZaiTian_Huo;
		this.skill_name = '飞龙在天-火';
		this.action_type = EActionType.INITIATIVE;
		this.kind = ESkillType.FeiLongZaiTian_Huo;
