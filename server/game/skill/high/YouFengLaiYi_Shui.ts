...
export default class YouFengLaiYi_Shui extends SkillBase {
	constructor() {
		super();
		this.skill_id = ESkillType.YouFengLaiYi_Shui;
		this.skill_name = '高级如人饮水';
		this.action_type = EActionType.INITIATIVE;
		this.kind = ESkillType.YouFengLaiYi_Shui;
