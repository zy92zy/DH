...
export default class YouFengLaiYi_Tu extends SkillBase {
	constructor() {
		super();
		this.skill_id = ESkillType.YouFengLaiYi_Tu;
		this.skill_name = '高级西天净土';
		this.action_type = EActionType.INITIATIVE;
		this.kind = ESkillType.YouFengLaiYi_Tu;
