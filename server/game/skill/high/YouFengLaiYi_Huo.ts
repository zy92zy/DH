...
export default class YouFengLaiYi_Huo extends SkillBase {
	constructor() {
		super();
		this.skill_id = ESkillType.YouFengLaiYi_Huo;
		this.skill_name = '高级烽火燎原';
		this.action_type = EActionType.INITIATIVE;
		this.kind = ESkillType.YouFengLaiYi_Huo;
