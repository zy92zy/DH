...
class UserController extends Controller
{
    ...
    //新增
    public function save(Request $request, Agent $model, AgentValidate $validate)
    {
        $param           = $request->param();
    ...
    //查看
    public function read($id, Agent $model)
    {
    ...
    //更新
    public function update($id, Request $request, Agent $model, AgentValidate $validate)
    {
        $data            = $model::get($id);
        $param           = $request->param();
    ...
    //删除
    public function delete($id, Agent $model)
    {
